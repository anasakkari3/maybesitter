...
The historical Round-2 structural export for the React Native app in `mobile/`.
The accepted coral continuation is the current visual reference; see
`mobile/src/design/coral.source.json` and `docs/design/coral-continuation.md`.
...
- **Round:** 2 — replaces Round 1 (`d96ab124-…`, `MaybeSitter.dc.html`) as the
  navigation and layout foundation. Its teal palette was later superseded.
...
- This folder preserves the Round-2 structural source for `mobile/`; the coral
  reference and current palette are recorded in `mobile/src/design/`.
