...
function commitmentAlpha(): Commitment {
  return {
    ...
    timeSpec: { kind: 'due_by', dueAt: '2026-08-19T09:00:00.000Z', endAt: null, remindAt: null, allDay: false, timezone: 'UTC' },
...
function commitmentAlphaShuffled(): Commitment {
  return {
    ...
    postponedUntil: null,
    currentAckState: 'not_seen',
    timeSpec: { timezone: 'UTC', remindAt: null, allDay: false, dueAt: '2026-08-19T09:00:00.000Z', endAt: null, kind: 'due_by' },
