...
- Verify the merged HealthKit entitlement, health privacy manifest entry, and
  final user-facing read usage description against the archived iOS app.
